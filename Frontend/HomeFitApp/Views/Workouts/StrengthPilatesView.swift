...
struct StrengthPilatesView: View {
    ...
    var filteredWorkouts: [WorkoutCardModel] {
        allWorkouts
            .filter { $0.workoutType.lowercased() == "strength pilates" }
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                if isLoading {
                    ...
                    Text("No Strength Pilates workouts found for \(selectedLevel).")
        ...
        .navigationTitle("Strength Pilates")
