...
struct PowerPilatesView: View {
    ...
    var filteredWorkouts: [WorkoutCardModel] {
        allWorkouts
            .filter { $0.workoutType.lowercased() == "power pilates" }
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                if isLoading {
                    ...
                    Text("No Power Pilates workouts found for \(selectedLevel).")
